            ...
            <div class="container">
                <div class="row main-row">
                    ...
                    <div class="col-9 col-12-medium">
                        ...
                        <div id="fb-root"></div>
                        <script async defer crossorigin="anonymous" src="https://connect.facebook.net/zh_TW/sdk.js#xfbml=1&version=v13.0" nonce="8S6rG1s5"></script>


                        <div class="fb-comments" data-href="http://localhost/v5/rescue_showDetail.php?id=<?PHP echo $row['id'] ?>" data-width="" data-numposts="5"></div>
